...
FAKE = {
    ...
    # 1, 2, 4, 8, 16 array-operand steps, then the exp/log chain
    "chain": {
        "numpy": [2.4, 5.2, 10.9, 22.8, 51.6, 105.1, 113.8],
        "jix-plain": [2.6, 5.4, 12.2, 20.5, 38.5, 73.9, 115.9],
        "jix": [45.4, 48.0, 52.0, 58.4, 75.0, 104.1, 165.0],
    },
    "chain_memory": {
        "numpy": [0.0, 104e6, 208e6, 208e6, 208e6, 208e6],
        "jix-plain": [0.5e6, 1.0e6, 2.0e6, 2.7e6, 3.0e6, 3.1e6],
        "jix": [0.7e6, 0.7e6, 0.8e6, 0.8e6, 0.8e6, 0.9e6],
        "blosc2": [39.5e6, 45.0e6, 50.0e6, 52.7e6, 55.0e6, 56.0e6],
    },
    "rust_read": {
