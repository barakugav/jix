...
def test_chain(benchmark, library, steps):
    # Default read region, like every other section. Tuning it to a cache-sized region is worth a
    # lot here (see bench-report/FINDINGS.md) but it is a tuning result, not the default anyone
    # gets, and the report should show what a caller gets out of the box.
