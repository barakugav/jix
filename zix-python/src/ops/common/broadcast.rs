use pyo3::prelude::*;
use zix_core::ErrorKind;
use zix_core::{ops::Broadcast, NDIM_MAX};
...
fn broadcast_operand(operand: Operand, shape: &[u64]) -> Result<Operand, zix_core::Error> {
...
fn broadcast_shapes(shape1: &[u64], shape2: &[u64]) -> Result<DimArray<u64>, zix_core::Error> {
