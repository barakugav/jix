...
Mirrors the test block in zix/src/ops/cmp.rs.
"""
...
def test_equal(dtype: np.dtype, data: DataObject):
    ...
    assert_array_matches(zix.equal(za, zb), np_a == np_b, data=data)
...
def test_greater(dtype: np.dtype, data: DataObject):
    ...
    assert_array_matches(zix.greater(za, zb), np_a > np_b, data=data)
...
def test_greater_equal(dtype: np.dtype, data: DataObject):
    ...
    assert_array_matches(zix.greater_equal(za, zb), np_a >= np_b, data=data)
...
def test_less(dtype: np.dtype, data: DataObject):
    ...
    assert_array_matches(zix.less(za, zb), np_a < np_b, data=data)
...
def test_less_equal(dtype: np.dtype, data: DataObject):
    ...
    assert_array_matches(zix.less_equal(za, zb), np_a <= np_b, data=data)
...
def test_maximum(dtype: np.dtype, data: DataObject):
    ...
    assert_array_matches(zix.maximum(za, zb), np.maximum(np_a, np_b), data=data)
...
def test_minimum(dtype: np.dtype, data: DataObject):
    ...
    assert_array_matches(zix.minimum(za, zb), np.minimum(np_a, np_b), data=data)
