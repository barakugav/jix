...
Broadcasting is applied before dispatch: zix expands any 1-sized dimension and
...
def test_broadcast_numpy_scalar():
    ...
    result = zix.add(za, np.int32(100))
