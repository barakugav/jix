...
///
/// Copied from crossbeam.
/// https://docs.rs/crossbeam-utils/0.8.21/src/crossbeam_utils/cache_padded.rs.html
...
pub(crate) const CACHE_LINE_SIZE: usize = align_of::<CachePadded<u8>>();
